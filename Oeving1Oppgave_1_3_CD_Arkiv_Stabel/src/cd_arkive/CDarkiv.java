...
� En samling CD-er
Operasjoner:
� Legge inn en ny CD. Det er frivillig om du vil teste p� om den ligger der fra f�r.
� Slette en CD
� S�ker og henter CD-er med en gitt delstreng i tittelen
� S�ker og henter artister med en gitt delstreng i tittelen
� Henter antall CD-er
*/
	...
	public void leggTilCd(CD nyCD){
		...
		if (erLedigPlass()){
			...
			if(finnCD_nr(nyCD.getCdNumer())==-1) {
				...
				skjerm.outln("Feil melding: CD Nr("+nyCD.getCdNumer()+"), er registrert fra f�r");
			}
		}else{
	...
	@Override
	public CD [] sokTittel(String cdTl){//TODO m� teste null tabell
